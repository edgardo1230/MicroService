package com.nearshoretechnology.focalpoint.common.async.response;
...
public class AsyncResponseEntity<T> {
	...
	public AsyncResponseEntity(Observable<T> observable, MultiValueMap<String, String> headers, HttpStatus status) {
		this.observable = observable;
		this.headers = headers;
		this.status = status;
	}

	public AsyncResponseEntity(Single<T> single, MultiValueMap<String, String> headers, HttpStatus status) {
		this.single = single;
		this.headers = headers;
		this.status = status;
	}
