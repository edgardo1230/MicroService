...
public class DateUtils {
  ...
  public static Date weekAgoAsStartDate(Date date) {
  ...
  public static Date addWeeks(Date date, int weeks) {
    ...
    return asStartDate(calendar.getTime());    
  }

  public static Date weeksAgo(Date date, int weeks) {
  ...
  public static Date weekAgo(Date date) {
    ...
    return weeksAgo(date, 1);
  }

  public static Date twoWeeksAgo(Date date) {
    
    return weeksAgo(date, 2);
  }
  ...
  public static boolean inRange(Date lowerLimit, Date upperLimit, Date value) {
    
    return lowerLimit.before(value) && value.before(upperLimit);
  }
